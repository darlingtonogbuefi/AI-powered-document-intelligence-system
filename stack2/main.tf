...
module "bedrock_kb" {
  ...
  aurora_arn                 = "arn:aws:rds:us-west-2:553108038487:cluster:my-aurora-serverless"
  aurora_db_name             = "myapp"
  aurora_endpoint            = "my-aurora-serverless.cluster-czbxg30l5awz.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn          = "arn:aws:secretsmanager:us-west-2:553108038487:secret:my-aurora-serverless-JshLqU"
  s3_bucket_arn              = "arn:aws:s3:::bedrock-kb-553108038487"
}
